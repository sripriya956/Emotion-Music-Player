...
AI Emotion-based Music Player
The Emotion-Based Music Player is an intelligent system that detects a user’s emotional state in real time using facial expressions and automatically plays music that matches the detected mood.
